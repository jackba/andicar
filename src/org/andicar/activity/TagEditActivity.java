 ...
 * @author miki
 */
public class TagEditActivity extends EditActivityBase
{
    ...
    protected void saveData() {
        ...
        if( mRowId == -1 ) {
            mDbAdapter.createRecord(MainDbAdapter.TAG_TABLE_NAME, data);
            finish();
        }
        else {
            int updResult = mDbAdapter.updateRecord(MainDbAdapter.TAG_TABLE_NAME, mRowId, data);
            if(updResult != -1){
                String errMsg = "";
