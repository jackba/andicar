...
//                            " || '[#8] (' || " + sqlConcatTableColumn(EXPENSECATEGORY_TABLE_NAME, GEN_COL_NAME_NAME) + " || ')' " +
                ...
                " COALESCE( " + sqlConcatTableColumn(TABLE_NAME_TAG, COL_NAME_GEN_NAME) + " || '; ', '') || " + 
            			sqlConcatTableColumn(TABLE_NAME_REFUEL, COL_NAME_GEN_USER_COMMENT) + " || '[#1]' " +
                        " AS " + THIRD_LINE_LIST_NAME + ", " + //#3
                ...
                "(SELECT " + COL_NAME_REFUEL__INDEX + " " +
        			...
        			" LIMIT 1 " +
                "), -1) AS PreviousFullRefuelIndex," + //#13
...
//                "(SELECT SUM( " + sqlConcatTableColumn( "rf", COL_NAME_REFUEL__QUANTITY) + ")" +
//                " FROM " + TABLE_NAME_REFUEL + " AS rf " +
//                "WHERE " + WHERE_CONDITION_ISACTIVE +
//               			" AND rf." + COL_NAME_REFUEL__ISFULLREFUEL + " = 'N' " +
//               			" AND rf." + COL_NAME_REFUEL__CAR_ID + " = " + sqlConcatTableColumn(TABLE_NAME_REFUEL, COL_NAME_REFUEL__CAR_ID) +
//               			" AND rf." + COL_NAME_REFUEL__INDEX + " < " + sqlConcatTableColumn(TABLE_NAME_REFUEL, COL_NAME_REFUEL__INDEX) +
//               			" AND rf." + COL_NAME_REFUEL__INDEX + " > " + 
//	                        "(SELECT " + COL_NAME_REFUEL__INDEX + " " +
//	                    	" FROM " + TABLE_NAME_REFUEL + " AS pr " +
//	                    	" WHERE " + WHERE_CONDITION_ISACTIVE + 
//	                    			" AND pr." + COL_NAME_REFUEL__ISFULLREFUEL + " = 'Y' " +
...
//	            			" LIMIT 1 " +
//	            			")"+
//        			") AS TotalQtyBetweenFullRefuels" + //#16
    ...
    public static String refuelListReportSelect =
            "SELECT " +
                ...
                "CASE strftime(\"%w\", " + sqlConcatTableColumn(TABLE_NAME_REFUEL, COL_NAME_REFUEL__DATE) +
                    ...
                    "WHEN \"5\" THEN '[#d5]' " +
                    "WHEN \"6\" THEN '[#d6]' " +
                "END AS " + StaticValues.DAY_OF_WEEK_NAME + ", " + //#12
                ...
                "(SELECT " + COL_NAME_REFUEL__INDEX + " " +
        			...
        			" ORDER BY pr." + COL_NAME_REFUEL__INDEX + " DESC " +
        			" LIMIT 1 " +
                "), -1) AS PreviousFullRefuelIndex_DoNotExport, " +  //#27
